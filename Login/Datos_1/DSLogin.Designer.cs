...
SELECT Nombres, Apellidos, Telefono, Correo, Usuario, Contraseña FROM Datos WHERE (Usuario = @Usuario)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Datos_1.Properties.Settings.Default.Login_1ConnectionString;
        }
        ...
        public virtual int spr_AgregarUsuarios(string Nombres, string Apellidos, string Telefono, string Correo, string Usuario, string Contraseña) {
